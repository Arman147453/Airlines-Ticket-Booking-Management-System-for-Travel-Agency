...
<body>
    ...
    <ol>
        <li>1. Password is stored in blanked format for security purposes.</li>
        <li>2. To change your password, enter a new password and click on 'Save Changes'.</li>
        <li>3. If you don't want to change your password, leave the password field empty.</li>
    </ol>
</div>
